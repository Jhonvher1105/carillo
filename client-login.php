...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['signup'])) {
    ...
    if (!$username || !$first_name || !$last_name || !$email || !$contact_number || !$password || !$confirm_password) {
        ...
        try {
            ...
            $signup_error = "An error occurred. Please try again later.";
...
<body>
        ...
        <!-- Login Form -->
            ...
            <form method="post" action="">
                ...
                <?php elseif ($signup_success): ?>
                    <p class="success-message" style="color:green;"> <?= $signup_success ?> </p>
                <?php endif; ?>
            </form>
            </div>
        </div>
    ...
    <span class="close-button">&times;</span>
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Carillo Law.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Carillo Law, accessible from <a href="http://localhost/final%20proj%20-%20web(updated%20with%20login%20and%20signup)/final%20proj%20-%20web/index.php" rel="external nofollow noopener" target="_blank">http://localhost/final%20proj%20-%20web(updated%20with%20login%20and%20signup)/final%20proj%20-%20web/index.php</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>
        <p>By email: pccarillolaw@gmail.com</p>
        </li>
        <li>
        <p>By phone number: 0973 727 8473</p>
        </li>
        </ul>
    </div>
    </div>
